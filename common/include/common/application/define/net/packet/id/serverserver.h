 ...
 * @uses 服务器与服务器之间的通讯包
 */
#ifndef PS_COMMON_APPLICATION_DEFINE_NET_PACKET_ID_SERVERSERVER_H_
#define PS_COMMON_APPLICATION_DEFINE_NET_PACKET_ID_SERVERSERVER_H_
...
#endif //PS_COMMON_APPLICATION_DEFINE_NET_PACKET_ID_SERVERSERVER_H_
