...
uint16_t AskAuth::getid() const {
  using namespace 
    ps_common_application::define::net::packet::id::login_togateway; 
  return kAskAuth;
}
...
ps_common_net::packet::Base *AskAuthFactory::createpacket() {
  __ENTER_FUNCTION
    ps_common_net::packet::Base *result = new AskAuth();
    return result;
  __LEAVE_FUNCTION
    return NULL;
}
